...
interface Props {
  visible: boolean;
  onClose: () => void;
  onCreate: (title: string, description: string, color: number, targetStreak: number, reminderTime: string | null) => void;
}
...
export function CreateTaskModal({ visible, onClose, onCreate }: Props) {
  ...
  function handleSubmit() {
    ...
    onCreate(title.trim(), description.trim(), hue, targetStreak, reminderTime);
    reset();
    onClose();
  }
        ...
        <View style={styles.sheet}>
          <ScrollView contentContainerStyle={{ padding: 20 }} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.actions}>
              ...
              >
                <Text style={[styles.btnText, { color: '#030712', fontWeight: '600' }]}>+ Create</Text>
              </Pressable>
            </View>
          </ScrollView>
        </View>
